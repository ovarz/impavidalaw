  ...
  <div class="footer-top section-container">
    <div class="footer-top-container width-max">
			...
			<div class="fcs-list">
              ...
              ?>
				...
				href="<?php echo($fcs_list['fcs_link'])?>">
				  <?php require ($_SERVER['IL'].'img/icon/footer-'. $fcs_list['fcs_icon'] .'.svg')?>
				</a>
			  <?php } ?>
			</div>
		  </div>
	  ...
	  <div class="footer-address">
		...
		<a aria-label="Impavida Headquarter" title="Impavida Headquarter" class="footer-address-detail" href="" target="_blank">
